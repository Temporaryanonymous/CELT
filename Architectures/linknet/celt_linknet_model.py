...
from ..base import CELT_SegmentationHead,CELT_SegmentationModel, ClassificationHead
from ..encoders import get_encoder


class CELT_Linknet(CELT_SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = CELT_LinknetDecoder(
