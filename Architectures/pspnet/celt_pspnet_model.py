...
from .celt_pspnet_decoder import CELT_PSPDecoder
from ..encoders import get_encoder

from ..base import CELT_SegmentationHead,CELT_PSPNet_SegmentationModel, ClassificationHead


class CELT_PSPNet(CELT_PSPNet_SegmentationModel):
