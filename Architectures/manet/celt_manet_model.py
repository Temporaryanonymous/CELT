...
from .celt_manet_decoder import CELT_MAnetDecoder
from ..encoders import get_encoder
from ..base import CELT_SegmentationModel,CELT_SegmentationHead,SegmentationModel, SegmentationHead, ClassificationHead


class CELT_MAnet(CELT_SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = CELT_MAnetDecoder(
