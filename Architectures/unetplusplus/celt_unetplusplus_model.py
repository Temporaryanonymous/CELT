...
from .celt_unetplusplus_decoder import CELT_UnetPlusPlusDecoder
from ..encoders import get_encoder
from ..base import CELT_SegmentationModel, CELT_SegmentationHead, ClassificationHead

class CELT_UnetPlusPlus(CELT_SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = CELT_UnetPlusPlusDecoder(
